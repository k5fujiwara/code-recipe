...
| :--- | :--- |
| トップページ | サイトの入口 |
| このサイトについて | [このサイトについて](/about/)（サイト概要・運営目的） |
...
Sitemap: https://code-recipes.com/sitemap.xml
```
...
https://code-recipes.com/ads.txt
...
- [お問い合わせ](/contact/)・[このサイトについて](/about/)・[運営者情報](/operator/)・[利用規約・免責事項](/terms/)
