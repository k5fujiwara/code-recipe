...
範囲内の素数をまとめて数えたり、何度も素数判定をしたりするなら、試し割りよりも [エラトステネスの篩](/docs/algorithms/sieve-of-eratosthenes/) が向いています。
...
詳しい手順は、[素因数分解](/docs/algorithms/prime-factorization/) のページで確認できます。
